...
def LayerAddWeights(builder, weights):
    builder.PrependUOffsetTRelativeSlot(
        3, flatbuffers.number_types.UOffsetTFlags.py_type(weights), 0
    )
...
def LayerAddWeightsShape(builder, weightsShape):
    builder.PrependUOffsetTRelativeSlot(
        4, flatbuffers.number_types.UOffsetTFlags.py_type(weightsShape), 0
    )
...
def LayerAddBias(builder, bias):
    builder.PrependUOffsetTRelativeSlot(
        5, flatbuffers.number_types.UOffsetTFlags.py_type(bias), 0
    )
...
def LayerAddBiasShape(builder, biasShape):
    builder.PrependUOffsetTRelativeSlot(
        6, flatbuffers.number_types.UOffsetTFlags.py_type(biasShape), 0
    )
...
def LayerAddProbability(builder, probability):
    builder.PrependFloat32Slot(7, probability, 0.0)
...
def LayerAddStartDim(builder, startDim):
    builder.PrependInt32Slot(8, startDim, 0)
...
def LayerAddEndDim(builder, endDim):
    builder.PrependInt32Slot(9, endDim, 0)
...
def LayerAddOutSize(builder, outSize):
    builder.PrependUOffsetTRelativeSlot(
        10, flatbuffers.number_types.UOffsetTFlags.py_type(outSize), 0
    )
...
def LayerAddEps(builder, eps):
    builder.PrependFloat32Slot(11, eps, 0.0)
...
def LayerAddMomentum(builder, momentum):
    builder.PrependFloat32Slot(12, momentum, 0.0)
...
def LayerAddNumBatchesTracked(builder, numBatchesTracked):
    builder.PrependInt32Slot(13, numBatchesTracked, 0)
...
def LayerAddRunningMean(builder, runningMean):
    builder.PrependUOffsetTRelativeSlot(
        14, flatbuffers.number_types.UOffsetTFlags.py_type(runningMean), 0
    )
...
def LayerAddRunningMeanShape(builder, runningMeanShape):
    builder.PrependUOffsetTRelativeSlot(
        15, flatbuffers.number_types.UOffsetTFlags.py_type(runningMeanShape), 0
    )
...
def LayerAddRunningVar(builder, runningVar):
    builder.PrependUOffsetTRelativeSlot(
        16, flatbuffers.number_types.UOffsetTFlags.py_type(runningVar), 0
    )
...
def LayerAddRunningVarShape(builder, runningVarShape):
    builder.PrependUOffsetTRelativeSlot(
        17, flatbuffers.number_types.UOffsetTFlags.py_type(runningVarShape), 0
    )
...
def LayerAddKernelSize(builder, kernelSize):
    builder.PrependUOffsetTRelativeSlot(
        18, flatbuffers.number_types.UOffsetTFlags.py_type(kernelSize), 0
    )
...
def LayerAddDilation(builder, dilation):
    builder.PrependUOffsetTRelativeSlot(
        19, flatbuffers.number_types.UOffsetTFlags.py_type(dilation), 0
    )
...
def LayerAddGroups(builder, groups):
    builder.PrependInt32Slot(20, groups, 0)
...
def LayerAddInChannels(builder, inChannels):
    builder.PrependInt32Slot(21, inChannels, 0)
...
def LayerAddOutChannels(builder, outChannels):
    builder.PrependInt32Slot(22, outChannels, 0)
...
def LayerAddPadMode(builder, padMode):
    builder.PrependUOffsetTRelativeSlot(
        23, flatbuffers.number_types.UOffsetTFlags.py_type(padMode), 0
    )
...
def LayerAddPadding(builder, padding):
    builder.PrependUOffsetTRelativeSlot(
        24, flatbuffers.number_types.UOffsetTFlags.py_type(padding), 0
    )
...
def LayerAddStride(builder, stride):
    builder.PrependUOffsetTRelativeSlot(
        25, flatbuffers.number_types.UOffsetTFlags.py_type(stride), 0
    )
...
def LayerAddDataLayout(builder, dataLayout):
    builder.PrependUOffsetTRelativeSlot(
        26, flatbuffers.number_types.UOffsetTFlags.py_type(dataLayout), 0
    )
...
def LayerAddCeilMode(builder, ceilMode):
    builder.PrependBoolSlot(27, ceilMode, 0)
...
def LayerAddUpscaleFactor(builder, upscaleFactor):
    builder.PrependInt32Slot(28, upscaleFactor, 0)
